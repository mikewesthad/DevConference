...
const Home: NextPage = () => {
  return (
    <div className={styles.container}>
      <Head>
        <title>Replit Con</title>
        <meta
          name="description"
          content="Join us at Dev Con. Connect, learn, and explore the future of coding!"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={styles.main}>
        <h1 className={styles.title}>Dev Con 2024</h1>

        <p className={styles.description}>
          Join us at Dev Con. Connect, learn, and explore the future of coding!
        </p>
